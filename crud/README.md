...
A build of the [_7guis-crud_ sample](https://feathersui.com/samples/haxe-openfl/7guis-crud/) is hosted on the Feathers UI website, and it may be viewed in any modern web browser.
